...
ggsave("output/figures/modelfit_testscores.png",g,width=4.5,height=3.8)
...
ggsave("output/figures/modelfit_testscores_relative.png",g,width=4,height=3)
...
ggsave("output/figures/dissolution.png",g,width=5,height=3.5)
